...
namespace NAXB.UnitTests
{
    ...
    public abstract class XPathProcessorTestBase
    {
        ...
        {
            var compiled = Processor.CompileXPath(XPathProvider.SingleElement.XPath, Namespaces);
        ...
        {
            var compiled = Processor.CompileXPath(XPathProvider.SingleAttribute.XPath, Namespaces);
        ...
        {
            var compiled = Processor.CompileXPath(XPathProvider.MultipleElements.XPath, Namespaces);
        ...
        {
            var compiled = Processor.CompileXPath(XPathProvider.MultipleAttributes.XPath, Namespaces);
